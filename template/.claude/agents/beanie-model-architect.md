...
- Core scaffolding models exist in `src/core/models/` (IMMUTABLE - DO NOT MODIFY)
...
- Never modify files in `src/core/models/` directory - they are immutable scaffolding
- Always place new models directly in `src/app/models/`
- Import core models with: `from core.models import UserModel`
- Import core mixins with: `from core.models.mixins import TimeStampMixin`
