...
- Application models belong in `src/app/models/`
- Core scaffolding models exist in `src/vibetuner/models/` (IMMUTABLE - DO NOT MODIFY)
- Models typically inherit from Document with common mixins from core
...
- Never modify files in `src/vibetuner/models/` directory - they are immutable scaffolding
- Always place new models directly in `src/app/models/`
- Import core models with: `from vibetuner.models import UserModel`
- Import core mixins with: `from vibetuner.models.mixins import TimeStampMixin`
...
- Models with TimeStampMixin automatically get db_insert_dt/db_update_dt fields (UTC timestamps)
